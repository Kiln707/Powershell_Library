...
#		This Template contains the needed functions for the manipulation of the Security Policy
#		This will need to be ran as an Administrator to make changes to majority of Security Policy
###########################################################################################################################
...
write-host $(Get-AccountsWithUserRight SeInteractiveLogonRight)